...
colors = ["#5FA137", "#6799ce", "#aa4499", "#f0c041", "#4b71bb", "#a3a3a3"]
...
with open(f, 'r') as csvfile:
	...
	mean_seqbaseX=[]
	mean_seqbaseXVal=[]
	toolmean_seqbase = {"UNCALLED": [], "RawHash": [], "RawHash2-Minimizer": []}
...
ax.bar(idx[0:4], sequenced_bases[0:4], color=colors, width=0.99, align="center", edgecolor="black", linewidth=1.2)
ax.bar(idx[4:8], sequenced_bases[4:8], color=colors, width=0.99, align="center", edgecolor="black", linewidth=1.2)
ax.bar(idx[8:12], sequenced_bases[8:12], color=colors, width=0.99, align="center", edgecolor="black", linewidth=1.2)
ax.bar(idx[12:16], sequenced_bases[12:16], color=colors, width=0.99, align="center", edgecolor="black", linewidth=1.2)
ax.bar(idx[16:20], sequenced_bases[16:20], color=colors, width=0.99, align="center", edgecolor="black", linewidth=1.2)
