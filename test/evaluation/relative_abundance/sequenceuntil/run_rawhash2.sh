...
/usr/bin/time -vpo relative_abundance_rawhash2_fast_sequenceuntil.time rawhash2 --sequence-until -t 32 ../rawhash2/relative_abundance_rawhash2_fast.ind ../../../data/random_community/fast5_files/ > relative_abundance_rawhash2_fast_sequenceuntil.paf

/usr/bin/time -vpo relative_abundance_rawhash2_fast.time rawhash2 -t 32 ../rawhash2/relative_abundance_rawhash2_fast.ind ../../../data/random_community/fast5_files/ > relative_abundance_rawhash2_fast.paf
