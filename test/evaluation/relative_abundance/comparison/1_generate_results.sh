...
uncalled pafstats -r ../true_mappings.paf --annotate ../rawhash/relative_abundance_rawhash_sensitive.paf > relative_abundance_rawhash_sensitive_ann.paf 2> relative_abundance_rawhash_sensitive.throughput
...
uncalled pafstats -r ../true_mappings.paf --annotate ../rawhash/relative_abundance_rawhash_faster.paf > relative_abundance_rawhash_faster_ann.paf 2> relative_abundance_rawhash_faster.throughput

python ../../../scripts/compare_pafs.py relative_abundance_uncalled_ann.paf relative_abundance_sigmap_ann.paf relative_abundance_rawhash_sensitive_ann.paf > relative_abundance_rawhash_sensitive.comparison
...
python ../../../scripts/compare_pafs.py relative_abundance_uncalled_ann.paf relative_abundance_sigmap_ann.paf relative_abundance_rawhash_faster_ann.paf > relative_abundance_rawhash_faster.comparison

for i in '../true_mappings.paf' '../uncalled/relative_abundance_uncalled.paf' '../sigmap/relative_abundance_sigmap.paf' '../rawhash/relative_abundance_rawhash_sensitive.paf' '../rawhash/relative_abundance_rawhash_fast.paf' '../rawhash/relative_abundance_rawhash_faster.paf' ; do
if test -f $i; then
