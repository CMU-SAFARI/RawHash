...
python ../../../scripts/compare_pafs.py relative_abundance_uncalled_ann.paf relative_abundance_sigmap_ann.paf relative_abundance_rawhash_fast.throughput relative_abundance_rawhash_fast_ann.paf > relative_abundance_rawhash_fast.comparison
python ../../../scripts/compare_pafs.py relative_abundance_uncalled_ann.paf relative_abundance_sigmap_ann.paf relative_abundance_rawhash_fast.throughput relative_abundance_w3_rawhash_fast_ann.paf > relative_abundance_w3_rawhash_fast.comparison
