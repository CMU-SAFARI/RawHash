...
colors = ["#6799ce", "#db8043", "#aa4499", "#f0c041", "#4b71bb", "#a3a3a3", "#5FA137"]
...
ax.bar(idx[0:2], sequenced_chunks[0:2], color=colors, width=0.99, align="center", edgecolor="black", linewidth=1.2)
ax.bar(idx[2:4], sequenced_chunks[2:4], color=colors, width=0.99, align="center", edgecolor="black", linewidth=1.2)
ax.bar(idx[4:6], sequenced_chunks[4:6], color=colors, width=0.99, align="center", edgecolor="black", linewidth=1.2)
ax.bar(idx[6:8], sequenced_chunks[6:8], color=colors, width=0.99, align="center", edgecolor="black", linewidth=1.2)
ax.bar(idx[8:10], sequenced_chunks[8:10], color=colors, width=0.99, align="center", edgecolor="black", linewidth=1.2)
# ax.set_yscale("log")
